...
CREATE TABLE `items` (
  ...
  `img` varchar(45) DEFAULT '0',
  `composition` varchar(50) DEFAULT '0',
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='items to buy';
...
-- Dump completed on 2020-10-29 14:28:53
